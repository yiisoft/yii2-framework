...
return [
    ...
    'Options available: {options}' => 'Pieejamas opcijas: {options}',
    'Powered by {yii}' => 'Darbojas ar {yii}',
    'The combination {values} of {attributes} has already been taken.' => 'Kombinācija {values} {attributes} ir jau aizņemta.',
    'The format of {filter} is invalid.' => '{filter} formāts ir kļūdains',
    'Unknown alias: -{name}' => 'Neatpazīts pseidonīms {name}',
